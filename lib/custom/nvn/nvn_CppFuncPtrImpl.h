...
void nvnLoadCPPProcs(Device* device, DeviceGetProcAddressFunc getProc) {
    ...
    pfncpp_nvnMultisampleStateSetAlphaToCoverageEnable =
        (MultisampleStateSetAlphaToCoverageEnableFunc)getProc(device, "nvnMultisampleStateSetAlphaToCoverageEnable");
    pfncpp_nvnMultisampleStateSetAlphaToCoverageDither =
        (MultisampleStateSetAlphaToCoverageDitherFunc)getProc(device, "nvnMultisampleStateSetAlphaToCoverageDither");
    ...
    pfncpp_nvnMultisampleStateGetAlphaToCoverageEnable =
        (MultisampleStateGetAlphaToCoverageEnableFunc)getProc(device, "nvnMultisampleStateGetAlphaToCoverageEnable");
    pfncpp_nvnMultisampleStateGetAlphaToCoverageDither =
        (MultisampleStateGetAlphaToCoverageDitherFunc)getProc(device, "nvnMultisampleStateGetAlphaToCoverageDither");
    ...
    pfncpp_nvnMultisampleStateSetCoverageModulationMode =
        (MultisampleStateSetCoverageModulationModeFunc)getProc(device, "nvnMultisampleStateSetCoverageModulationMode");
    pfncpp_nvnMultisampleStateGetCoverageModulationMode =
        (MultisampleStateGetCoverageModulationModeFunc)getProc(device, "nvnMultisampleStateGetCoverageModulationMode");
    pfncpp_nvnMultisampleStateSetCoverageToColorEnable =
        (MultisampleStateSetCoverageToColorEnableFunc)getProc(device, "nvnMultisampleStateSetCoverageToColorEnable");
    pfncpp_nvnMultisampleStateGetCoverageToColorEnable =
        (MultisampleStateGetCoverageToColorEnableFunc)getProc(device, "nvnMultisampleStateGetCoverageToColorEnable");
    pfncpp_nvnMultisampleStateSetCoverageToColorOutput =
        (MultisampleStateSetCoverageToColorOutputFunc)getProc(device, "nvnMultisampleStateSetCoverageToColorOutput");
    pfncpp_nvnMultisampleStateGetCoverageToColorOutput =
        (MultisampleStateGetCoverageToColorOutputFunc)getProc(device, "nvnMultisampleStateGetCoverageToColorOutput");
    pfncpp_nvnMultisampleStateSetSampleLocationsEnable =
        (MultisampleStateSetSampleLocationsEnableFunc)getProc(device, "nvnMultisampleStateSetSampleLocationsEnable");
    pfncpp_nvnMultisampleStateGetSampleLocationsEnable =
        (MultisampleStateGetSampleLocationsEnableFunc)getProc(device, "nvnMultisampleStateGetSampleLocationsEnable");
    ...
    pfncpp_nvnMultisampleStateSetSampleLocationsGridEnable =
        (MultisampleStateSetSampleLocationsGridEnableFunc)getProc(device, "nvnMultisampleStateSetSampleLocationsGridEnable");
    pfncpp_nvnMultisampleStateGetSampleLocationsGridEnable =
        (MultisampleStateGetSampleLocationsGridEnableFunc)getProc(device, "nvnMultisampleStateGetSampleLocationsGridEnable");
    ...
    pfncpp_nvnCommandBufferBindTransformFeedbackBuffer =
        (CommandBufferBindTransformFeedbackBufferFunc)getProc(device, "nvnCommandBufferBindTransformFeedbackBuffer");
    pfncpp_nvnCommandBufferBindTransformFeedbackBuffers =
        (CommandBufferBindTransformFeedbackBuffersFunc)getProc(device, "nvnCommandBufferBindTransformFeedbackBuffers");
    ...
    pfncpp_nvnCommandBufferSetInnerTessellationLevels =
        (CommandBufferSetInnerTessellationLevelsFunc)getProc(device, "nvnCommandBufferSetInnerTessellationLevels");
    pfncpp_nvnCommandBufferSetOuterTessellationLevels =
        (CommandBufferSetOuterTessellationLevelsFunc)getProc(device, "nvnCommandBufferSetOuterTessellationLevels");
    ...
    pfncpp_nvnCommandBufferMultiDrawArraysIndirectCount =
        (CommandBufferMultiDrawArraysIndirectCountFunc)getProc(device, "nvnCommandBufferMultiDrawArraysIndirectCount");
    pfncpp_nvnCommandBufferMultiDrawElementsIndirectCount =
        (CommandBufferMultiDrawElementsIndirectCountFunc)getProc(device, "nvnCommandBufferMultiDrawElementsIndirectCount");
    ...
    pfncpp_nvnCommandBufferSetConservativeRasterEnable =
        (CommandBufferSetConservativeRasterEnableFunc)getProc(device, "nvnCommandBufferSetConservativeRasterEnable");
    pfncpp_nvnCommandBufferSetConservativeRasterDilate =
        (CommandBufferSetConservativeRasterDilateFunc)getProc(device, "nvnCommandBufferSetConservativeRasterDilate");
    ...
    pfncpp_nvnCommandBufferSetRenderEnableConditional =
        (CommandBufferSetRenderEnableConditionalFunc)getProc(device, "nvnCommandBufferSetRenderEnableConditional");
    ...
    pfncpp_nvnCommandBufferTiledDownsampleTextureView =
        (CommandBufferTiledDownsampleTextureViewFunc)getProc(device, "nvnCommandBufferTiledDownsampleTextureView");
    ...
    pfncpp_nvnCommandBufferBindCoverageModulationTable =
        (CommandBufferBindCoverageModulationTableFunc)getProc(device, "nvnCommandBufferBindCoverageModulationTable");
    ...
    pfncpp_nvnCommandBufferSetColorReductionThresholds =
        (CommandBufferSetColorReductionThresholdsFunc)getProc(device, "nvnCommandBufferSetColorReductionThresholds");
