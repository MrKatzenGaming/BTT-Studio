...
public:
    ...
    void operator()() const {
        if (this->mInstance && this->mFunctionPtr) return (this->mInstance->*(this->mFunctionPtr))();
    }
...
public:
    ...
    void operator()(A1 a1) const {
        if (this->mInstance && this->mFunctionPtr) return (this->mInstance->*(this->mFunctionPtr))(a1);
    }
...
public:
    ...
    void operator()(A1 a1, A2 a2) const {
        if (this->mInstance && this->mFunctionPtr) return (this->mInstance->*(this->mFunctionPtr))(a1, a2);
    }
...
public:
    ...
    void operator()() const {
        if (this->mFunctionPtr) return (*this->mFunctionPtr)();
    }
...
public:
    ...
    void operator()(A1 a1) const {
        if (this->mFunctionPtr) return (*this->mFunctionPtr)(a1);
    }
...
public:
    ...
    void operator()(A1 a1, A2 a2) const {
        if (this->mFunctionPtr) return (*this->mFunctionPtr)(a1, a2);
    }
...
class AnyDelegate : public detail::AnyDelegateImpl<IDelegate, AnyDelegate, sizeof(Delegate<detail::DummyClassForDelegate>)> {
public:
...
template <typename R>
class AnyDelegateR : public detail::AnyDelegateImpl<IDelegateR<R>, AnyDelegateR<R>, sizeof(DelegateR<detail::DummyClassForDelegate, R>)> {
public:
    using Base = detail::AnyDelegateImpl<IDelegateR<R>, AnyDelegateR<R>, sizeof(DelegateR<detail::DummyClassForDelegate, R>)>;
...
template <typename A1>
class AnyDelegate1 : public detail::AnyDelegateImpl<IDelegate1<A1>, AnyDelegate1<A1>, sizeof(Delegate1<detail::DummyClassForDelegate, A1>)> {
public:
...
template <typename A1, typename R>
class AnyDelegate1R : public detail::AnyDelegateImpl<IDelegate1R<A1, R>, AnyDelegate1R<A1, R>, sizeof(Delegate1R<detail::DummyClassForDelegate, A1, R>)> {
public:
...
template <typename A1, typename A2>
class AnyDelegate2 : public detail::AnyDelegateImpl<IDelegate2<A1, A2>, AnyDelegate2<A1, A2>, sizeof(Delegate2<detail::DummyClassForDelegate, A1, A2>)> {
public:
...
template <typename A1, typename A2, typename R>
class AnyDelegate2R
    : public detail::AnyDelegateImpl<IDelegate2R<A1, A2, R>, AnyDelegate2R<A1, A2, R>, sizeof(Delegate2R<detail::DummyClassForDelegate, A1, A2, R>)> {
public:
    using Base = detail::AnyDelegateImpl<IDelegate2R<A1, A2, R>, AnyDelegate2R<A1, A2, R>, sizeof(Delegate2R<detail::DummyClassForDelegate, A1, A2, R>)>;
